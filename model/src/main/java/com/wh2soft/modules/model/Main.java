...
import com.wh2soft.modules.model.api.PokeApiClient;
import com.wh2soft.modules.model.api.PokeApiService;
    ...
    public static void main(String... args) {
        ...
        call.enqueue(new Callback<Pokemon>() {
            ...
            public void onResponse(Call<Pokemon> call, Response<Pokemon> response) {
                ...
                System.exit(0);
                // Domain (Emitir un evento con los datos obtenidos)
            }
            ...
            public void onFailure(Call<Pokemon> call, Throwable t) {
                ...
                System.exit(0);
                // Domain (Emitir un evento con el error)
            }
        });
    }
