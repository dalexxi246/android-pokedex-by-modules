package com.wh2soft.pokedex.domain;

import com.wh2soft.pokedex.domain.users.OnSignInCancelledListener;
import com.wh2soft.pokedex.domain.users.SignInCase;
import com.wh2soft.pokedex.domain.users.SignInCaseImpl;
import com.wh2soft.pokedex.model.users.UsersRepository;
...
//        executeTest_SignIn();
    ...
    private static void executeTest_SignIn() {
